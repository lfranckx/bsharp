...
export default function Footer() {
    ...
    return(
        <footer id='footer'>
            ...
            <small>Copyright © 2021. All rights reserved. B# Music Lessons. LLC | Website proudly created by <a className='link' href='https://www.lfxmedia.io/' rel='noopener' target='_blank' >LFX Media</a></small>
        </footer>
    );
}